...
//                  ""应监管要求,请你务必审慎阅读、充分理解“隐私政策”各条款，包括但不限于：为了向你提供精准广告、优化游戏体验等，我们需要收集你的设备信息等个人信息。\n"" +
                    ...
                    "" 使用者：字节跳动SDK，Gromore SDK，优量汇SDK，快手联盟SDK\n"" +
                    ...
                    "" 用于何种追踪目的：收集数据的主要目的是用于“第三方广告-显示广告”。\n"" +
                    ""\n"" +
                    "" 数据类型：MAC 地址、AndroidID、获取设备硬件序列号/获取IMEI/获取MEID\n"" +
                    "" 使用者：字节跳动SDK，Gromore SDK，优量汇SDK，快手联盟SDK\n"" +
                    "" 使用目的：第三方广告：技术上我们将收集一些设备信息（例如，系统语言、屏幕高宽、屏幕方向、屏幕DPI信息等）。\n"" +
                    "" 是否与身份关联：收集数据的主要目的是用于“第三方广告-显示广告”，在获得用户授权的情况下，才与设备ID、标识符相关联。\n"" +
                    "" 用于何种追踪目的：收集数据的主要目的是用于“第三方广告-显示广告”。\n"" +
                    ""\n"" +
                    "" 数据类型：传感器列表、读写存储权限、读取电话状态、IMSI、网络设备制造商、OAID、android ID、bssid 设备应用列表、WiFi 信息、设备版本、手机样式、系统版本\n"" +
                    "" 使用者：TapTap TapDB SDK\n"" +
                    "" 使用目的：提供了一套专注于解决游戏项目数据需求的分析工具，通过简单的接入就可以获得丰富实用的数据看板和广告追踪能力，让数据分析和广告投放变得轻松易操作，同时也可以用于分析人群画像，帮助开发者更好地理解用户。\n"" +
                    "" 是否与身份关联：收集数据的主要目的是用于“数据分析”，在获得用户授权的情况下，才与设备ID、标识符相关联。\n"" +
                    "" 用于何种追踪目的：收集数据的主要目的是用于“数据分析”。\n"" +
                    ""\n"" +
