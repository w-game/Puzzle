...
{
    public class GMAdSlotRewardVideo : GMAdSlotBase<GMAdSlotRewardVideo.Builder>
    {
        ...
        private GMAdSlotRewardVideo(Builder builder) : base(builder)
        {
            ...
            AndroidSlot = builder.GetAndroidSlot($"{SlotClassPackage}.GMAdSlotRewardVideo");
#endif
        }
        ...
        public new class Builder : GMAdSlotBase<Builder>.Builder
        {
            ...
            public Builder() : base(
#if UNITY_ANDROID && !UNITY_EDITOR
                new AndroidSlotHelper($"{SlotClassPackage}.GMAdSlotRewardVideo$Builder")
#endif
            )
            {
            }
