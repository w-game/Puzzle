...
namespace ByteDance.Union
{
    ...
    public sealed class ABUSDKInitConfig
    {
        ...
        private static ABUSDKInitConfig _adSlot = null;

        public static ABUSDKInitConfig CreateSharedInitConfig()
        {
            if (_adSlot == null)
            {
                _adSlot = new ABUSDKInitConfig();
            }
            return _adSlot;
        }
        ...
        public class Builder
        {
            ...
            {
                ABUSDKInitConfig.CreateSharedInitConfig().appID = appID;
                return this;
            }
            ...
            {
                ABUSDKInitConfig.CreateSharedInitConfig().openDebugLog = openDebugLog;
                return this;
            }
