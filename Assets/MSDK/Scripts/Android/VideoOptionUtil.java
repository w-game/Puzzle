...
public class VideoOptionUtil {
    ...
    public static TTVideoOption getTTVideoOption(boolean muted) {
        //广点通（GDT）单独使用配置
        GDTExtraOption gdtExtraOption = new GDTExtraOption.Builder()
                .setGDTAutoPlayMuted(muted)//自动播放是否静音，默认true
                .setGDTDetailPageMuted(muted)//详情页是否静音，默认值为false，即有声播放；
    ...
    public static TTVideoOption getTTVideoOption2(boolean muted) {
        //广点通（GDT）单独使用配置
        GDTExtraOption gdtExtraOption = new GDTExtraOption.Builder()
                .setGDTAutoPlayMuted(muted)//自动播放是否静音，默认true
                .setGDTDetailPageMuted(muted)//详情页是否静音，默认值为false，即有声播放；
