//
//  ABUDCustomInterstitialAdapter.m
//  ABUDemo
//
...
#import "ABUDCustomInterstitialAdapter.h"
#import "ABUDCustomInterstitialView.h"
#import "ABUDStoreViewController.h"

@interface ABUDCustomInterstitialAdapter ()

@property (nonatomic, strong) ABUDCustomInterstitialView *view;
...
@implementation ABUDCustomInterstitialAdapter
...
- (BOOL)showAdFromRootViewController:(UIViewController *)viewController parameter:(NSDictionary *)parameter {
    ...
    self.view = [ABUDCustomInterstitialView interstitialViewWithSize:self.size];
    [self.view showInViewController:viewController];
    __weak __typeof(self) ws = self;
    // 模拟广告关闭事件
    self.view.closeCallback = ^(ABUDCustomInterstitialView * _Nonnull view) {
