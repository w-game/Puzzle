...
namespace Common
{
    ...
    public abstract class LanguageBase
    {
        ...
        public abstract string GetPowerText { get; }
    ...
    public class SimplifiedChinese : LanguageBase
    {
        ...
        public override string GetPowerText => "获得5点体力";
    ...
    public class English : LanguageBase
    {
        ...
        public override string GetPowerText => "Get（5）";
    ...
    public class TraditionalChinese : LanguageBase
    {
        ...
        public override string GetPowerText => "獲得5點體力";
